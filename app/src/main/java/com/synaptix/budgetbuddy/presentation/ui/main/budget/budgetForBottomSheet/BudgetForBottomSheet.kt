package com.synaptix.budgetbuddy.presentation.ui.main.budget.budgetForBottomSheet
...
class budgetForBottomSheet : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.budget_for_bottom_sheet, container, false)
